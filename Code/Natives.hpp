...
namespace Big
{
	...
	namespace MISC
	{
		static void LOAD_CLOUD_HAT(const char* name, float transitionTime) { invoke<Void>(0xFC4842A34657BFCB, name, transitionTime); } // 0xFC4842A34657BFCB 0xED88FC61
		...
		inline void WATER_OVERRIDE_FADE_IN(float p0) { invoke<Void>(0xA8434F1DFF41D6E7, p0); } // 0xA8434F1DFF41D6E7 0x5F3DDEC0
	...
	namespace NETWORK
	{
		...
		inline BOOL NETWORK_ADD_FRIEND(int* p0, const char* p1) { return invoke<BOOL>(0x8E02D73914064223, p0, p1); } // 0x8E02D73914064223 0x20E5B3EE
	...
	namespace PLAYER
	{
		...
		inline void SET_PLAYER_MODEL(Player player, Hash model) { invoke<Void>(0xA1CADD00108836, player, model); } // 0x00A1CADD00108836 0x774A4C54
		inline void SET_PLAYER_NOISE_MULTIPLIER(Player player, float multiplier) { invoke<Void>(0x00A1CADD00108836, player, multiplier); } // 0xDB89EF50FF25FCE9 0x15786DD1
	...
	namespace SHAPETEST
	{
		inline int GET_SHAPE_TEST_RESULT(int rayHandle, int* hit, Vector3* endCoords, Vector3* surfaceNormal, Entity* entityHit) { return invoke<int>(0x3D87450E15D98694, rayHandle, hit, endCoords, surfaceNormal, entityHit); } // 0x3D87450E15D98694 0xF3C2875A
	...
	namespace TASK
	{
		inline void TASK_SKY_DIVE(Ped ped, BOOL p1) { invoke<Void>(0x601736CFE536B0A0, ped, p1); } // 0x601736CFE536B0A0 0xD3874AFA b323
		inline void TASK_PARACHUTE(Ped ped, BOOL p1, BOOL p2) { invoke<Void>(0xD2F1C53C97EE81AB, ped, p1, p2); } // 0xD2F1C53C97EE81AB 0xEC3060A2 b323
		inline void TASK_PARACHUTE_TO_TARGET(Ped ped, float x, float y, float z) { invoke<Void>(0xB33E291AFA6BD03A, ped, x, y, z); } // 0xB33E291AFA6BD03A 0xE0104D6C b323
		inline void CLEAR_PED_SECONDARY_TASK(Ped ped) { invoke<Void>(0x176CECF6F920D707, ped); } // 0x176CECF6F920D707 0xA635F451 b323
	...
	namespace VEHICLE
	{
		...
		inline BOOL IS_VEHICLE_ALARActivated(Vehicle vehicle) { return invoke<BOOL>(0x4319E335B71FFF34, vehicle); } // 0x4319E335B71FFF34 0xF2630A4C
		...
		inline void SET_VEHICLE_HAS_UNBREAKABLE_LIGHTS(Vehicle vehicle, BOOL p1) { invoke<Void>(0x1AA8A837D2169D94, vehicle, p1); } // 0x1AA8A837D2169D94 0x009AB49E b323
